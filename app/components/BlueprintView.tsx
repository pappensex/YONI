...
import GoddessMode from './GoddessMode'
        ...
        <div className="grid">
          <section className="card flow">
            ...
            <textarea
              ...
              placeholder="Frag CHIBot: z.B. Welche Seite ist online?"
              rows={4}
            />
            <div className="row">
              <button className="primary" onClick={handleAsk} disabled={isLoading}>
              ...
              {feed.map((item) => (
                <div key={item.id} className="item">
                  <div className="title-row">
                    ...
                    {item.isFusion && <span className="pill subtle">Fusion</span>}
                  </div>
                  <p className="muted">{item.text}</p>
                </div>
              ))}
              {feed.length === 0 && <p className="muted">Noch keine Fragen gestellt.</p>}
            </div>
          </section>
          ...
          <section className="card">
            <div className="section-header">
              <div>
                <p className="eyebrow">Ebenen</p>
                <h2>Daten + Seiten</h2>
              </div>
              <button className="primary">Jetzt prüfen</button>
            </div>
              ...
              <div className="blueprint-block">
                ...
                <div className="list">
                  {blueprint.pages.map((page) => (
                    <div key={page.path} className="list-row">
                      <div>
                        <div className="title-row">
                      ...
                      <div className="pill subtle">Owner: {page.owner}</div>
                    </div>
                  ))}
                </div>
              </div>
                    ...
                    <div key={layer.name} className="list-row">
                      <div>
                        ...
                        <p className="muted small">
                          Cadence: {layer.cadence} • Retention: {layer.retention}
                        </p>
                      </div>
                    </div>
                  ))}
          ...
          <section className="card flow">
            <div className="section-header">
              <div>
                <p className="eyebrow">Identitäten</p>
                <h2>Profile</h2>
              </div>
              <div className="pill">{blueprint.profiles.length} Archetypen</div>
            </div>
            <div className="list">
          ...
          <section className="card flow">
            <div className="section-header">
              <div>
                ...
                <h2>Agenten & Versprechen</h2>
              </div>
              <div className="pill">{blueprint.bots.length} aktiv</div>
            </div>
            <div className="list">
          ...
          <section className="card flow">
            <div className="section-header">
              <div>
                ...
                <h2>Cadence & Signals</h2>
              </div>
              <div className="pill">{blueprint.rituals.length} aktiv</div>
            </div>
            <div className="list">
          ...
          <section className="card flow">
            <div className="section-header">
              ...
              <button className="primary">Als erledigt markieren</button>
            </div>
            <div className="list">
              {blueprint.actions.map((action) => (
                <div key={action.title} className="list-row">
                  ...
                  <div className="pill subtle">Owner: {action.owner}</div>
                </div>
              ))}
            </div>
          </section>
