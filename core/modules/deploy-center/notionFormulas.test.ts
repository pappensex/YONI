...
import { prop, round, format, toNumber, calculateSubtasksDone } from './notionFormulas';
...
console.log('  prop(testData, "Subtasks Done"):', prop(testData, "Subtasks Done"));
...
console.log('  calculateSubtasksDone(data):', calculateSubtasksDone({ "Subtasks Done": 5.7 }));
console.log('  Expected: 6');
...
console.log('  calculateSubtasksDone({ "Subtasks Done": percentage }):', 
